...
return array(
    ...
    */
    ...
    'dimensions' => [
        'width'  => env('THUMBNAIL_IMAGE_WIDTH', 190),
        'height' => env('THUMBNAIL_IMAGE_HEIGHT', 130),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Specify default thumbnail image
    |
    */

    'default_img' => 'img/progress.png',
    ...
    */
    ...
    'watermark' => [
        'image' => [
            ...
            'path'    => env('WATERMARK_IMAGE_PATH', 'http://voluntarydba.com/pics/YouTube%20Play%20Button%20Overlay.png'),
        ],
        'video' => [
            'enabled' => env('WATERMARK_VIDEO', false),
            'path'    => env('WATERMARK_VIDEO_PATH', ''),
        ],
    ],
